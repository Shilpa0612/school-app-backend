-- ============================================================================
-- DATABASE OPTIMIZATIONS FOR SCHOOL APP (CORRECTED VERSION)
-- ============================================================================
...
GROUP BY cta.id, cta.teacher_id, cta.class_division_id, cta.is_active, cta.created_at,
...
BEGIN
    ...
    WHERE 
        ...
        AND (p_teacher_id IS NULL OR oh.teacher_id = p_teacher_id)
...
BEGIN
    ...
    RAISE NOTICE '- Homework (corrected)';
