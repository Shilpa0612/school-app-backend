-- ============================================================================
-- DATABASE OPTIMIZATIONS FOR SCHOOL APP (FIXED VERSION)
-- ============================================================================
...
GROUP BY h.id, h.title, h.description, h.subject, h.due_date, h.class_division_id, h.assigned_by, h.created_at,
         cd.division, cl.name, cl.sequence_number, ay.year_name,
