...
-- for the school app backend, especially as data grows to thousands of records
...
-- Composite indexes for timetable queries
...
-- =====================================================
-- 13. CALENDAR AND EVENTS INDEXES
-- =====================================================
...
-- =====================================================
-- 16. PARTIAL INDEXES FOR COMMON FILTERS
-- =====================================================
...
-- =====================================================
-- 17. FUNCTIONAL INDEXES FOR TEXT SEARCH
-- =====================================================
