-- Database Performance Optimization Script (Excluding Timetable)
-- This script adds comprehensive indexes to improve query performance
-- for the school app backend, excluding timetable system
...
-- =====================================================
-- 15. PARTIAL INDEXES FOR COMMON FILTERS
-- =====================================================
...
-- =====================================================
-- 16. FUNCTIONAL INDEXES FOR TEXT SEARCH
-- =====================================================
...
-- =====================================================
-- 17. COMPOSITE INDEXES FOR COMPLEX QUERIES
-- =====================================================
...
BEGIN
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'Note: Timetable indexes were excluded from this script.';
    RAISE NOTICE 'When you implement the timetable system, run the full';
    RAISE NOTICE 'optimization script to include timetable indexes.';
END $$;
